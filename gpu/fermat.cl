            ...
            
{
    ...
    output[gid].x = inputA[gid].x + inputA[gid].x;
    output[gid].y = inputA[gid].y + inputA[gid].y;
    output[gid].z = inputA[gid].z + inputA[gid].z;
    output[gid].w = inputA[gid].w + inputA[gid].w;
